...
if(isset($_REQUEST["asset"]) & $_REQUEST["asset"]==$name) {
	...
	echo "<li style=\"background-color: rgb(0, 79, 74);display:block;height:40px;width:800px;font-size:70%\"><table ><tr><td width=\"160px\">".$time."</td><td>".$messone."</td></tr></table></li>";
	...
	if(!isset($_REQUEST["asset"])) {
				...
				echo "<li style=\"background-color: rgb(0, 79, 74);display:block;height:40px;width:800px;font-size:70%\"><table ><tr><td width=\"140px\">".$time."</td><td width=\"280px\" align=left><a href=/?&unicode=".$turn."&asset=".$x_value.">".$x_value."</a></td><td>".$messone."</td></tr></table></li>";
