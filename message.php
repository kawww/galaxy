...
$x_value=str_replace("U+","",$x_value);
			...
			echo "<li style=\"background-color: rgb(0, 79, 74);display:block;height:40px;width:800px;font-size:70%\"><table ><tr><td width=\"150px\">".date('Y-m-d H:i', $time)."</td><td width=\"350px\" align=left><a href=/?&unicode=".$turn."&asset=".$from.">".$x_value."</a> (<a href=https://gotoipfs.com/#path=".$ipfs.">IPFS</a>)</td><td><a href=/?&unicode=".$turn."&asset=".$to.">TO: ".$to."</a></td></tr></table></li>";
