				...
				for (var f = 0; f < count; f++) {
					...
					ftwo+='<span class=\"one\">]</span>';
						...
						str += '<li style=\"animation: textShadow 1.00s infinite;box-shadow:0px 0px 20px 1px #59fbea,0px 0px 10px 1px #59fbea inset;background-color:  rgb(255,255,0,0.4);display:block;height:125px;width:125px;line-height:10px;font-size:24px;padding-top:10px;padding-left:10px;padding-right:10px;letter-spacing:1px;word-break: normal;\"><p style=\"font-size:12px;center;\">'+fone+'<br><span style=\"letter-spacing:5.2px;padding-left:4px;\">' + datalist[i].block + '</span><br>'+ftwo+'</p><br><p><span style=\"border:0px solid 28f428;padding:5px 5px 5px 5px;line-height:20px;\"><a href=\"/stone.php?lang=&asset=' + datalist[i].np + '&showall=11&stone=1&group=no\"  target=_blank>' + datalist[i].npn + '</a></span></p></li>';
							...
							{
						str += '<li style=\"animation: textShadow 1.00s infinite;box-shadow:0px 0px 20px 1px #59fbea,0px 0px 10px 1px #59fbea inset;background-color:rgb(0, 79, 74);display:block;height:125px;width:125px;line-height:10px;font-size:24px;padding-top:10px;padding-left:10px;padding-right:10px;letter-spacing:1px;word-break: normal;\"><p style=\"font-size:12px;center;\">'+fone+'<br><span style=\"letter-spacing:5.2px;padding-left:4px;\">' + datalist[i].block + '</span><br>'+ftwo+'</p><br><p><a href=\"/subscription.php?lang=&txid=' + datalist[i].tx + '\"  target=_blank><span style=\"border:0px solid 28f428;padding:5px 5px 5px 5px;line-height:20px;\">' + datalist[i].npn + '</span></a></p></li>';
							}

						}
						  else{
						  str += '<li style=\"animation: textShadow 1.00s infinite;box-shadow:0px 0px 20px 1px #59fbea,0px 0px 10px 1px #59fbea inset;background-color: #222222;display:block;height:125px;width:125px;line-height:10px;font-size:24px;padding-top:10px;padding-left:10px;padding-right:10px;letter-spacing:1px;word-break: normal;\"><p style=\"font-size:12px;center;\">'+fone+'<br><span style=\"letter-spacing:5.2px;padding-left:4px;\">' + datalist[i].block + '</span><br>'+ftwo+'</p><br><p><span style=\"border:1px solid #59fbea;padding:5px 5px 5px 5px;line-height:20px;box-shadow:0px 0px 5px 1px #59fbea,0px 0px 5px 1px #59fbea inset;\">&#x5f85;&#x6a5f;</span></p></li>';}
...
if(!$np){
	...
	$stat="<span style=\"border:1px solid #59fbea;padding:5px 5px 5px 5px;line-height:20px;box-shadow:0px 0px 5px 1px #59fbea,0px 0px 5px 1px #59fbea inset;\">&#x5f85;&#x6a5f;</span>";
		...
		if(!$nptrue){
		$stat="<span style=\"border:0px solid #28f428;padding:5px 5px 5px 5px;line-height:20px;\"><a href=\"/subscription.php?lang=&txid=".$txa."\" target=_blank>".$npn."</a></span>";}
		...
		{$stat="<span style=\"border:0px solid #28f428;padding:5px 5px 5px 5px;line-height:20px;\"><a href=\"/stone.php?lang=&asset=".$np."&showall=11&stone=1&group=no\">".$npn."</a></span>";}
							...
							echo "<p style=\"font-size:12px;center;\">".$fone."<br><span style=\"letter-spacing:5.2px;padding-left:4px;\">".$block."".$count."</span><br>".$ftwo."</p><br><p>".$stat."</span></p></li>";
